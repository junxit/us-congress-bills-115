...
## § 2. Eligibility of tribal libraries and qualifying anchor institutions for E-rate support
...
- **(2)** by adding at the end the following:
  ...
  >     - **(B)**
  >       - **(i)** develop performance goals and measures to track progress on achieving the strategic objective of the Commission of ensuring that all tribal libraries have affordable access to broadband Internet access service technologies for educational purposes for students, teachers, librarians, and members of the community; and
