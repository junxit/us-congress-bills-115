...
> To amend title 17, United States Code, to implement the Marrakesh Treaty, and for other purposes.

## § 1. Short title

This Act may be cited as the “Marrakesh Treaty Implementation Act”.

## § 2. Implementation amendments
...
- **(a)** *In general* Chapter 1 of title 17, United States Code, is amended—
  - **(1)** in section 121—
    ...
    - **(D)** in subsection (d)—
      ...
      - **(v)** by inserting after paragraph (2), as so redesignated, the following:
...
- **(b)** *Table of sections amendment* The table of sections for chapter 1 of title 17, United States Code, is amended by inserting after the item relating to section 121 the following:
