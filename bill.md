...
## § 2. Internal Revenue Service seizure requirements with respect to structuring transactions
...
- **(2)** by adding at the end the following:
  ...
  >     - **(II)** provide each such person with a notice of the seizure and of the person’s rights under clause (iv).
