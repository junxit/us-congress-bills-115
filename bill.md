...
- **(2)** in subsection (c)—
  ...
  - **(C)** by striking paragraph (2) and inserting the following:
    ...
    >     - **(iv)** with respect to 2 or more applications that are given the same priority under clause (ii), give priority to an application that requests less grant funding than loan funding.
