...
## § 2. Interagency working group to study Federal efforts to collect data on sexual violence
...
- **(c)** *Duties* The Working Group shall consider the following:
  ...
  - **(3)** Whether the context which led to an act of sexual violence should impact how that act is accounted for in reports.
