...
- **(2)** in paragraph (1)—
  - **(A)** by striking “pilot project” and inserting “program (referred to in this subsection as the “program”)”;
  - **(B)** by striking “conduct” and inserting “carry out”;
  - **(C)** by inserting “domestically grown” before “unprocessed”; and
  - **(D)** by striking “more than 8” and inserting “less than 15”;
...
- **(5)** in paragraph (4)—
  ...
  - **(C)** by adding at the end the following:
    > - **(D)** the demonstrated ability of the States to competitively procure domestically grown unprocessed fruits and vegetables.
...
- **(7)** by adding at the end the following:
  > - **(6)** *Funding*
  >   - **(A)** *Mandatory funding* There is appropriated to carry out this subsection $15,000,000 for each of fiscal years 2019 through 2023.
