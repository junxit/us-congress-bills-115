...
## § 2. Improvements to Federal agency teleworking programs
...
- **(b)** *Telework participation goals* Chapter 65 of title 5, United States Code, is amended as follows:
  - **(1)** In section 6502—
    - **(A)** in subsection (b)—
      ...
      - **(iii)** by adding at the end the following:
        ...
        > - **(7)** include methods for collecting data on, setting goals for, and reporting costs savings to the executive agency achieved through teleworking, consistent with the guidance developed under section 2(c) of the Telework Metrics and Cost Savings Act.
  ...
  - **(2)** In section 6506(b)(2)—
    ...
    - **(C)** by adding at the end the following:
      ...
      > - **(I)** a detailed explanation of a plan to increase the Government-wide teleworking participation rate above such rate applicable to fiscal year 2016, including agency-level plans to maintain or improve such rate for each of the teleworking frequency categories listed under subparagraph (A)(iii).
...
- **(d)** *Technical correction* Section 6506(b)(1) of title 5, United States Code, is amended by striking “with Chief” and inserting “with the Chief”.
