...
- **(7)** by adding at the end the following:
  ...
  > - **(d)** *Tribal roll*
  >   - **(1)** *In general* For the purpose of the delivery of Federal services and benefits described in subsection (a), the tribal roll in effect on the date of enactment of this section shall, subject to verification by the Secretary, define the service population of the Tribe.
