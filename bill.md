...
## § 2. Cross-Subsidization of Customer-Side Technology
...
- **(b)** *Compliance*
  - **(1)** *Time limitations* Section 112(b) of the Public Utility Regulatory Policies Act of 1978 (16 U.S.C. 2622(b)) is amended by adding at the end the following:
    > - **(7)**
    >   - **(A)** Not later than 1 year after the date of enactment of this paragraph, each State regulatory authority (with respect to each electric utility for which it has ratemaking authority), and each nonregulated electric utility shall, with respect to the standard established by paragraph (20) of section 111(d)—
