...
- **(3)** *Costs of greenhouse gases*
  - **(A)** *In general* The term costs of greenhouse gases means the monetized present discounted values, in dollars, of the current and future net costs to society that result from—
    - **(i)** 1 ton of emissions of a specific greenhouse gas in a specific year, including damage relating to—
...
## § 4. Cost of carbon dioxide, cost of methane, and cost of nitrous oxide
...
## § 5. Interagency Working Group on the Costs of Greenhouse Gases
...
- **(a)** *Revision evaluation*
  ...
  - **(2)** *Considerations* In carrying out a revision evaluation under paragraph (1) or a revision under subsection (b), the Working Group shall—
    - **(A)** consider—
      ...
      - **(iv)** new domestic and international findings; and
      - **(v)** all harm caused by greenhouse gas emissions;
...
- **(c)** *Authorization of appropriations* There are authorized to be appropriated to the Secretary of Commerce such sums as are necessary to administer the Committee.
