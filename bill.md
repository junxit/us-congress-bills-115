...
## § 3. Buffalo Bayou National Heritage Area
...
- **(4)** conduct meetings open to the public at least semiannually regarding the development and implementation of the management plan; and
- **(5)** submit an annual report to the Secretary that describes the activities, expenses, and income of the management entity (including grants to any other entities during the year that the report is made).
...
- **(b)** *Requirements* The management plan shall—
  ...
  - **(3)** include—
    ...
    - **(D)** a program of implementation for the management plan by the management entity that includes a description of actions to facilitate ongoing collaboration among partners to—
...
- **(d)** *Approval or disapproval of management plan*
  ...
  - **(4)** *Amendments* The Secretary shall approve or disapprove each amendment to the management plan that the Secretary determines makes a substantial change to the management plan.
...
- **(a)** *In general* Ten years after the establishment of the Heritage Area, the Secretary shall—
...
- **(b)** *Evaluation* An evaluation conducted under subsection (a)(1) shall—
  ...
  - **(2)** analyze the Federal, State, local, and private investments in the Heritage Area to determine the impact of the investments; and
