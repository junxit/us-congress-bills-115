...
- **(a)** *Hospital care and medical services for veterans*
  - **(1)** *In general* Paragraph (1) of section 1710(e) of title 38, United States Code, is amended by adding at the end the following new subparagraph:
    ...
    >     - **(I)** With respect to exposure to per­fluoro­octanoic acid—
...
## § 3. Presumption of service connection for certain veterans exposed to per­fluoro­octanoic acid or other per- and polyfluoroalkyl substances
...
- **(a)** *In general* Chapter 11 of title 38, United States Code, is amended by inserting after section 1116 the following new section:
  > ## § 1116A. Presumption of service connection for certain veterans exposed to per­fluoro­octanoic acid or other per- and poly­fluoro­alkyl substances
  >
  ...
  >   - **(1)** With respect to exposure to per­fluoro­octanoic acid—
