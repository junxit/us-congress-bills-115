...
## § 3. Analysis of distributed energy resources, the value of grid services, and advanced transmission assets
...
- **(b)** *Study on valuation of electric grid services*
  - **(1)** *In general* Not later than 1 year after the date of enactment of this Act, and not less frequently than once every 3 years thereafter, the Secretary and the Commission shall conduct a comprehensive study that—
    ...
    - **(B)** identifies and analyzes—
      ...
      - **(ii)**
        - **(I)** the specific electric grid services, the value of which is conditioned by locational value and temporal value; and
...
## § 4. Electrification of vehicles and heating
...
## § 7. Flexible Grid Challenge 2022
