...
- **(a)** *Study required* The Comptroller General of the United States shall conduct a study on how virtual currencies and online marketplaces are used to facilitate sex and drug trafficking. The study shall consider—
  ...
  - **(5)** the participants (state and non-state actors) throughout the entire supply chain that participate in or benefit from the buying, selling, or financing of goods and services associated with sex or drug trafficking (either through online marketplaces or virtual currencies) destined for, originating from, or within the United States;
  ...
  - **(7)** how virtual currencies and their underlying technologies can be used to detect and deter these illicit activities; and
  - **(8)** to what extent can the immutable and traceable nature of virtual currencies contribute to the tracking and prosecution of illicit funding.
