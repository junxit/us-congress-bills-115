...
## § 2. Program on establishment of peer specialists in patient aligned care team settings within medical centers of Department of Veterans Affairs
...
- **(f)** *Reports*
  - **(1)** *Periodic reports*
    ...
    - **(B)** *Elements* Each report required by subparagraph (A) shall, with respect to the 180-day period preceding the submittal of the report, include the following:
