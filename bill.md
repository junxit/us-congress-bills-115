...
- **(b)** *Facility capabilities*
  - **(1)** *Capabilities* The Secretary shall ensure that the facility described in subsection (a) will provide, at a minimum, the following capabilities:
    - **(A)** Fast neutron spectrum irradiation capability.
    - **(B)** Capacity for upgrades to accommodate new or expanded research needs.
  - **(2)** *Considerations* In carrying out paragraph (1), the Secretary shall consider the following:
