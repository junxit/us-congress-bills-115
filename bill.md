...
- **(2)** Internet deployment and related coordination, capacity building, and build once policies and approaches in developing countries, including actions to encourage—
...
- **(3)** policy changes that encourage first-time affordable access to the Internet in developing countries, including actions to encourage—
...
- **(5)** the use of the Internet to increase economic growth and trade, including—
...
- **(6)** use of the Internet to bolster democracy, government accountability, transparency, and human rights, including through the establishments of policies, initiatives, and investments that—
...
## § 6. Department of State organization
...
- **(b)** *Activities* In recognition of the added value of technical knowledge and expertise in the policymaking and diplomatic channels, the Secretary of State shall—
...
## § 10. Reporting requirement on implementation efforts
