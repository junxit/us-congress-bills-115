...
## § 2. Comprehensive Everglades restoration plan
...
- **(2)** by adding at the end the following:
  ...
  >   - **(A)** any project identified in the Plan for which a project implementation report is completed that is in accordance with an integrated delivery schedule approved by the Chief of Engineers and the South Florida Water Management District, in consultation with the South Florida Ecosystem Restoration Task Force, subject to the condition that the report is completed not later than 5 years after the date of enactment of this paragraph; and
