...
- **(2)** in paragraph (3)—
  ...
  - **(B)** by striking “Code, shall be” and inserting the following:
    > Code—
  ...
  - **(D)** by adding at the end the following:
    > - **(B)** to the maximum extent practicable, not less than 5 percent shall be expended through service-connected disabled veteran-owned small business concerns.
