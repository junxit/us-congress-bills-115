...
- **(e)** *Conforming amendments*
  ...
  - **(2)** Section 195(b)(2) of such Code is amended—
    - **(A)** by striking “amortization period.—In any case” and inserting the following:
      > amortization period.—
  ...
  - **(4)**
    - **(A)** Part VIII of subchapter B of chapter 1 of such Code is amended by striking section 248 (and by striking the item relating to such section in the table of sections for such part).
