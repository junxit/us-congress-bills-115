...
## § 2. Minimum jurisdictional standards for State and local sales and use tax collection
...
- **(a)** *In general* A State may not—
  ...
  - **(3)** treat a person as doing business in a State for purposes of any tax described in paragraph (1)(A),
...
- **(a)** *Definitions* For purposes of this Act:
  ...
  - **(5)** *Referrer* The term referrer shall mean every person who—
