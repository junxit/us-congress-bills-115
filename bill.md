...
- **(a)** *Definitions* In this section:
  - **(1)** *Apprentice* The term apprentice means an individual under the age of 21 who holds a commercial driver’s license.
  ...
  - **(5)** *Experienced driver* The term experienced driver means an individual who—
    ...
    - **(D)** has a minimum of 1 year of experience driving a commercial motor vehicle in interstate commerce.
  - **(6)** *On-duty time* The term on-duty time has the meaning given the term in section 395.2 of title 49, Code of Federal Regulations (as in effect on the date of enactment of this Act).
  - **(7)** *Pointed moving violation* The term pointed moving violation means a violation that results in points being added to the license of a driver, or a similar comparable violation, as determined by the Secretary.
...
- **(c)** *Apprenticeship program* An apprenticeship program referred to in subsection (b)(2) is a program that consists of the following requirements:
  - **(1)** *120-hour probationary period*
    ...
    - **(B)** *Performance benchmarks* In order to complete the 120-hour probationary period under subparagraph (A), an employer shall determine that the apprentice is competent in each of the following areas:
      - **(i)** Interstate, light city traffic, rural 2-lane, and evening driving.
      - **(ii)** Safety awareness.
