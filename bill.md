...
- **(a)** *State reporting systems as condition of receiving full Edward Byrne Memorial Justice Assistance Grants amounts*
  - **(1)** *In general* For each fiscal year beginning with fiscal year 2019, a State shall—
    ...
    - **(G)**
      - **(i)** ensure that any individual who—
...
## § 3. Additional Firearms Prohibitions to Federal NICS System Based on State Reporting Systems
...
- **(1)** in subsection (d)—
  ...
  - **(D)** by inserting after paragraph (9), the following new paragraph:
    > - **(10)** during the prior 6-month period, has communicated to a mental health professional a serious threat to commit an act of physical violence against another identifiable person.
