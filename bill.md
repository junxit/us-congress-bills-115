...
- **(1)** the terms Hold for Pickup service and Signature Confirmation service means the services described in sections 508.7.2.1 and 503.8.1.1.a, respectively, of the Domestic Mail Manual (or any successor services);
...
## § 3. Offering Hold for Pickup and Signature Confirmation services under the Secure Mail Initiative
...
- **(e)** *Use of private carrier*
  ...
  - **(2)** *Requirements* The Secretary may not exercise the authority under paragraph (1) unless the Secretary—
    ...
    - **(B)** provides for an option under the Secure Mail Initiative (or any successor program) under which a person to whom a document is sent under that initiative may elect a service under paragraph (1)(B);
