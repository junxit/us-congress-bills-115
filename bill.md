...
- **(e)** *Regulatory authority* Section 117 of such Code is amended by adding at the end the following new subsection:
  ...
  >   - **(1)** regulations defining under what conditions an individual is considered to live and work in a community for purposes of subsection (b)(2)(A)(2), and
  >   - **(2)** regulations to ensure the implementation and effectiveness of such subsection.

- **(f)** *Effective date* The amendments made by this section shall apply with respect to taxable years beginning after the date of enactment of this Act.
- **(g)** *Reports*
  ...
  - **(2)** *Comptroller General*
    ...
    - **(B)** *Contents* The information published under subparagraph (A) shall include the following:
      - **(i)** A description of the characteristics of individuals who receive post-graduation scholarship grants.
      - **(ii)** The length of time involved in such grants.
      - **(iii)** The amount paid out under such grants.
      - **(iv)** The disposition of any funds paid under such grants, including the identity of any loan holders who benefit from such funds.
