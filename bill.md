...
- **(2)** inserting after section 43 the following:
  ...
  >   - **(5)** *Opportunity to resubmit notification as APD* If the Secretary notifies an operator under paragraph (2) of an objection, the Secretary shall allow the operator to resubmit such information in the form of an APD.
  ...
  >     - **(F)** is managed by the Director of the Bureau of Land Management or the Chief of the U.S. Forest Service.
