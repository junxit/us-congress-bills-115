...
## § 2. Establishment of continuous diagnostics and mitigation program in Department of Homeland Security
...
- **(b)** *Continuous Diagnostics and Mitigation Strategy*
  ...
  - **(2)** *Scope* The strategy required under paragraph (1) shall include the following:
    ...
    - **(F)** Recommendations for future efforts and activities related to securing networks, devices, data, and information technology assets through the use of such program.
