...
This Act may be cited as the “Mobile Health Record Act of 2018”.
...
- **(a)** *Findings* Congress finds the following:
  ...
  - **(5)** According to a study published by Johns Hopkins University in 2016, more than 250,000 deaths per year are due to medical error, making it the 3rd leading cause of death in the United States. Further, millions of dollars are wasted on duplicative or unnecessary tests and procedures.
...
## § 3. Promoting patient access to personal medical claim information, including a patient’s providers, prescriptions, tests, and diagnoses, through the use of mobile health record applications
...
- **(a)** *Medicare* Title XVIII of the Social Security Act (42 U.S.C. 1395 et seq.) is amended by adding at the end the following new section:
  > ## § 1899C. Mobile Access to Personal Medical Information Program
  >
  > - **(a)** *Establishment*
