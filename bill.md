...
This Act may be cited as the “Ending Nonconsensual Online User Graphic Harassment Act of 2017” or the “ENOUGH Act”.
...
- **(a)** *In general* Chapter 88 of title 18, United States Code, is amended by adding at the end the following:
  ...
  >   - **(2)** *Distribute* The term distribute includes enabling access, such as by sharing a private reference.
  >   - **(3)** *Information content provider* The term information content provider has the meaning given that term in section 230(f) of the Communications Act of 1934 (47 U.S.C. 230(f)).
  >   - **(4)** *Intimate visual depiction* The term intimate visual depiction means any visual depiction (as that term is defined in section 2256(5))—
  ...
  >     - **(D)** in original or modified format, such as with a filter or text overlay.
  ...
  > - **(e)** *Threats and extortion* Any person who intentionally threatens to commit an offense under subsection (b), regardless of whether the threat is an act of extortion, shall be punished as provided in subsection (c).
