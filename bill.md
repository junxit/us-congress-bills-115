...
- **(b)** *Scope* In carrying out the program under subsection (a), the Secretary shall—
  ...
  - **(2)** prioritize—
    - **(A)** electric utilities with respect to which the Secretary has substantial concerns; and
    - **(B)** electric utilities with fewer available resources due to size or region; and
