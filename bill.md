...
- **(1)** *Covered vegetation management activity*
  ...
  - **(B)** *Description of activities* An activity referred to in subparagraph (A) is—
    ...
    - **(vi)** use of a herbicide, pesticide, or biological control agent, subject to the condition that the use shall be in accordance with applicable legal requirements, Federal agency procedures, and land use plans;
