...
## § 2. Closed-loop pumped storage projects
...
>   - **(4)** *Length of Process* The Commission shall ensure that the expedited process under this section will result in final decision on an application for a license by not later than 2 years after receipt of a completed application for such license.
...
>     - **(B)** such terms and conditions as the Commission deems appropriate to ensure that such closed-loop pumped storage project continues to comply with the provisions of this section and terms and conditions included in any such exemption.
