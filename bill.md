...
- **(a)** *Findings* Congress finds the following:
  ...
  - **(8)** Through their research, the Center developed the threat assessment model for responding to indicators of targeted violence, which includes a three-step process—
...
- **(a)** *In general* Chapter 203 of title 18, United States Code, is amended by adding the following:
  ...
  >     - **(B)** *Development* Training programs developed by the Center shall use best practices in school threat assessment, such as data produced through experimental, quasi-ex­per­i­men­tal, and non-experimental research.
