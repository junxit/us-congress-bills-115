...
This Act may be cited as the “Respond, Innovate, Succeed, and Empower Act of 2017” or the “RISE Act of 2017”.
...
>   - **(A)** Adopt policies that, at a minimum, make the following documentation submitted by an individual sufficient to establish that such individual is an individual with a disability:
...
>   - **(B)** Adopt policies that are transparent and explicit regarding information about the process by which the institution determines eligibility for accommodations.
>   - **(C)** Disseminate such information to students, parents, and faculty in an accessible format, including during any student orientation and making such information readily available on a public website of the institution.
