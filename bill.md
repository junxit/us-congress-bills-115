...
- **(2)** *Guidance document* The term “guidance document”—
  - **(A)** means an agency statement of general applicability (other than a rule that has the force and effect of law promulgated in accordance with the notice and public procedure under section 553 of title 5, United States Code) that—
