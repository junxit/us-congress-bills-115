...
## § 2. Stress test relief for nonbanks
...
- **(1)** in paragraph (1)(B)—
  ...
  - **(C)** in clause (iii), as so redesignated, by inserting before the semicolon the following:
    ...
    > - **(III)** are not already required by the company’s Federal primary financial regulatory agency
