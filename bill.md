...
- **(c)** *Data reports* Where appropriate, any report published by an agency that relies on survey demographic data shall include information on sexual orientation and gender identity.
...
- **(e)** *Applicability*
  - **(1)** *Rules of construction* Nothing in this section shall be construed—
    - **(A)** to require an individual to disclose their sexual orientation or gender identity to an agency; or
    - **(B)** to permit the use of information collected under this section in a manner that would adversely affect any individual.
