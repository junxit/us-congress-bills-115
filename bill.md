...
>     - **(C)** Based on the most recent data available from the American Community Survey available from the Department of Commerce, the estimated average income and percentage of employment in the State of domicile of the individual for persons with—
>       - **(i)** a high school diploma or equivalent;
>       - **(ii)** some postsecondary education without completion of a degree or certificate; and
...
>   - **(3)** *Students receiving Federal Pell Grants* The information to be provided under paragraph (1)(A) to each student receiving a Federal Pell Grant may include the following:
...
>         - **(I)** to accept the terms of the private education loan within 30 calendar days following the date on which the application for such loan is approved and the borrower receives the required disclosure documents, pursuant to section 128(e)(6) of the Truth in Lending Act (15 U.S.C. 1638(e)(6)); and
...
- **(1)** in paragraph (1)(A)—
  ...
  - **(C)** by inserting before clause (iv), as redesignated by subparagraph (B), the following:
  ...
  - **(D)** in clause (iv), as redesignated by subparagraph (B)—
  ...
  - **(E)** in clause (ix), as redesignated by subparagraph (B)—
  ...
  - **(F)** in clause (x), as redesignated by subparagraph (B), by striking “consolidation loan under section 428C or a”;
  - **(G)** in clauses (xi) and (xii), as redesignated by subparagraph (B), by striking “and” after the semicolon; and
