...
## § 2. Ports of entry threat and operational analysis
...
- **(a)** *In general*
  ...
  - **(2)** *Contents* The threat and operational analysis required under paragraph (1) shall include an assessment of the following:
    ...
    - **(E)** Processes conducted at ports of entry that do not require law enforcement training and could be—
      ...
      - **(ii)** automated.
    - **(F)** Improvements needed during secondary inspections to meet food safety standards defined by applicable statutes for the commodities being inspected.
