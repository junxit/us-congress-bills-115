...
- **(b)** *Purposes*
  - **(1)** *In general* The purposes of the Foundation are to—
    ...
    - **(B)** undertake, conduct, and encourage programs and activities, including by awarding grants, that support—
...
- **(d)** *Range of Foundation activities* The activities and grants made by the Foundation under subsection (b)(1)(B) that are not subject to limitations under section 4(d)(4) shall be undertaken in equal proportion under clauses (i) and (ii) of subsection (b)(1)(B).
...
- **(d)** *Powers* In addition to powers otherwise authorized under this Act, to carry out its purposes the Foundation shall have the usual powers of a not-for-profit corporation in the District of Columbia, including the power to—
  ...
  - **(4)** accept, receive, solicit, hold, administer, and use any gift, devise, or bequest, at the request of the donor thereof, strictly and exclusively for any purpose set forth in section 2(b), including for reasonable administrative expenses related to actions to carry out the bequest;
