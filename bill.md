...
>   - **(C)**
>     - **(i)** A claim of common law privilege by an agency, or an officer or employee of an agency, shall not prevent the Special Counsel from obtaining any material described in subparagraph (A) with respect to the agency.
>     - **(ii)** The submission of material described in subparagraph (A) by an agency to the Special Counsel may not be deemed to waive any assertion of privilege by the agency against a non-Federal entity or against an individual in any other proceeding.
