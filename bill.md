...
- **(1)** in paragraph (3)—
  ...
  - **(B)** by adding at the end the following:
    > - **(B)** *Limitation on average rate of return* The target average rate of return for reinsured companies for the 2018 reinsurance year and each subsequent reinsurance year shall be 9.6 percent of retained premiums.
